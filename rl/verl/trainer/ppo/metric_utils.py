...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    # print(f"other_tensor: {other_tensor}")
    ...
    metrics = {
        ...
        # behavior_bonus (other_tensor)
        "critic/behavior_bonus/mean": torch.mean(other_tensor).detach().item(),
        # score (total_score = acc + format + behavior_bonus)
